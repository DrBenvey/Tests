...
namespace Tests
{
    class Resources
    {
        ...
        {
            return "Вы приступаете к разделу теста, содержащий вопросы, для ответа на которые нужно сопоставить объекты. Перетените объекты, находящиеся выше разделительной чорной линии в соответсвующие им пропуски белого цвета, находящиеся ниже разделительной линии";
        }
    }
}
